...
#[KeyRegistry(
    ...
    superglobals: [],
    addKey: '1. Add constant. 2. Add BladeDirective enum case with #[ResolvesTo] pointing to a class carrying #[BladeRegistrar]. 3. Add entry to vite.config.js input array.'
)]
#[KeyRegistry(
