# ForbidHardcodedNamespacePrefixRector
...
```
// Hardcoded namespace prefix should be passed in as configuration. See: utils/rector/docs/ForbidHardcodedNamespacePrefixRector.md
```
